...
def entrenar(cnf):
    ...
    # 1. Cargar dataset completo (uno o varios tiles, ver Cnf.tiles)
    dataset_completo = CordobaDataset(cnf.dir_dataset, cnf.tiles, normalizar=cnf.normalizar, label_map=cnf.label_remap)
